...
**Plans:** 2/2 plans complete
Plans:
- [x] 07-01-PLAN.md — Add AABB collision detection (65% hitbox), per-gap scoring, live score HUD, localStorage high score persistence, and "new best" label
- [x] 07-02-PLAN.md — Create Web Audio oscillator sounds (jump/score/death) and wire into game events with iOS AudioContext unlock
